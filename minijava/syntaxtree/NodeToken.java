...
/*
 * This file is auto-generated. Manual edits will be
 * overwritten on next build.
 * Any automated tooling that generates code extending
 * or implementing classes in this file must adhere to
 * the following conventions to ensure compatibility
 * with the project's test and grading infrastructure:
 *   - type-checking methods use prefix 'chk'
 *   - type-constructing methods use prefix 'mk'
 *   - local type variables use the form xTy
 *     (e.g., aTy, bTy, rTy)
 */
